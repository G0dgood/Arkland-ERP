...
// Get Employee
export const getEmployeePayroll = createAsyncThunk('payroll/getEmployeePayroll', async (data, thunkAPI) => {
	try {
...
export const getEmployeePayrollDetails = createAsyncThunk('payroll/getEmployeePayrollDetails', async (data, thunkAPI) => {
	try {
