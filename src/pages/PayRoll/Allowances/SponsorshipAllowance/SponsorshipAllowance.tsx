...
import SpecialAllowancesComponent from './ SponsorshipAllowanceComponent';

const SponsorshipAllowance = ({ parameter }: any) => {
	...
	return (
		<div>
			{parameter && <SpecialAllowancesComponent />}
...
export default SponsorshipAllowance
