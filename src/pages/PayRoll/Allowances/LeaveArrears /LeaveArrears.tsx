...
import LeaveArrearsConponent from './LeaveArrearsConponent';
import BulkUpload from '../../../../components/BulkUpload/BulkUpload';



const LeaveArrears = ({ parameter }: any) => {
	...
	return (
		<div>
			{parameter && <LeaveArrearsConponent setSelectedRadio={setSelectedRadio} selectedRadio={selectedRadio} />}
