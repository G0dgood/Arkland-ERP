...
const LeaveArrearsConponent = ({ setSelectedRadio, selectedRadio }: any) => {
			...
			<div >
				...
				{selectedRadio === "radio-1" &&
					<div className='specialallowancescomponent-contaner'>
						...
						<div className='input'>
							<label className='input__label input-perameter-color'>Comment</label>
							<textarea rows={4}>
							</textarea>
						</div>
...
export default LeaveArrearsConponent
