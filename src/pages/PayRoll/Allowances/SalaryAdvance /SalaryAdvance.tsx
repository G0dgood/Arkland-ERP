...
import SalaryAdvanceComponent from './SalaryAdvanceComponent';
...
const SalaryAdvance = ({ parameter }: any) => {
	...
	return (
		<div>
			{parameter && <SalaryAdvanceComponent setSelectedRadio={setSelectedRadio} selectedRadio={selectedRadio} />}
