				...
				<div className='main-div'>
									...
									<div className='main-todo-Event' style={{ borderRadius: "4px" }}>
										...
										<div className='FiTrash2'>
											<span className='BsFillPinAngleFill'>
												<BsFillPinAngleFill size={20} /></span>
											<span><BsThreeDots size={25} /></span>
										</div>
									</div>
					...
					<div className='main-div-col-2'>
						<div className='main-todo-1'>
							...
							<div className='main-todo-Event' style={{ borderRadius: "4px" }}>
								<div className='main-todo-container'>
									<div className='main-todo-input'>		<Checkbox {...label} /></div>
									<div>
										<div>Call</div>
						...
						<div className='main-todo-2'>
							<Button variant="outlined" className='show-btn'>Show All</Button>
							<Button variant="contained" className='Add-btn'>Add New</Button>
						</div>
					</div>
					{/* Todos end */}
				</div>
