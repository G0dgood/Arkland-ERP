...
const MyWeekReport = ({ setkpidata }: any) => {
  ...
  return (
    ...
    <div id="reports">
      <h5 className="page-title">Week Report</h5>

      <div className='half-background mt-4'>
        <SearchComponent sortData={data} entriesPerPage={entriesPerPage} setEntriesPerPage={setEntriesPerPage} placeholder={"Week Report"} />
