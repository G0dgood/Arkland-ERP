...
const WeeklyReportTable4 = () => {
	return (
		<div>	<div id="table-wrapper">
			...
			<table>
				...
				<tr>
					<td>Karen M. McManus</td>
					<td>One of Us Is Next</td>
					<td>Created payment plan view and m odification editing </td>
					<td>Young Adult Fiction</td>
					<td>Young Adult Fiction</td>
					<td>Young Adult Fiction</td>
					<td>377</td>
				...
				<tr>
					<td>Karen M. McManus</td>
					<td>Improving the UI, workin tion and working on the completion of the payment plan</td>
					<td>Young Adult Fiction</td>
					<td>Young Adult Fiction</td>
					<td>Young Adult Fiction</td>
					<td>Young Adult Fiction</td>
...
export default WeeklyReportTable4