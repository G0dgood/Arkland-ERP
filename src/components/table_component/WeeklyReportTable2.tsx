		...
		<div>	<div id="table-wrapper">
			...
			<table>
				...
				<tr>
					<td>Karen M. McManus</td>
					<td>One of Us Is Next</td>
					<td>Created payment plan view  tion editing </td>
					<td>Young Adult Fiction</td>
					<td>Young Adult Fiction</td>
					<td>Young Adult Fiction</td>
					<td>377</td>
				...
				<tr>
					<td>Karen M. McManus</td>
					<td>Improving the UI, working application king on the completion of the payment plan</td>
					<td>Young Adult Fiction</td>
					<td>Young Adult Fiction</td>
					<td>Young Adult Fiction</td>
					<td>Young Adult Fiction</td>
...
export default WeeklyReportTable2